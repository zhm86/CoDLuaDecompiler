...
public class Function
{
    ...
    public string PrettyPrint(string funcName = "")
    {
        ...
        if (Parent == null)
        {
            str.AppendLine("-- Generated by CoDLuaDecompiler");
            str.AppendLine($"-- Version: {AppInfo.Version}");
            str.AppendLine($"-- Date: {DateTime.Now.ToString("dd-MM-yyyy HH:mm")}");
        }
        ...
        if (AppInfo.ShowFunctionData)
        {
            str.AppendLine($"-- Function ID: {Id}");
            if (Parent != null)
            {
                str.AppendLine($"-- Number of Parameters: {Parameters.Count}");
                str.AppendLine($"-- Number of Upvalues: {UpvalueBindings.Count}");
            }
            str.AppendLine($"-- Number of Instructions: {Instructions.Count}");
            str.AppendLine($"-- Number of Child Functions: {Closures.Count}");
        }
