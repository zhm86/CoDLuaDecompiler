...
{
    public class LuaFunctionT7 : LuaFunction
    {
        private readonly ILuaOpCodeTable _opCodeTable = new LuaOpCodeTableT7();
        
        public LuaFunctionT7(ILuaFile luaFile, BinaryReader reader) : base(luaFile, reader)
        {
        }
        ...
        protected override List<ILuaFunction> ReadChildFunctions()
        {
            ...
            {
                childFunctions.Add(new LuaFunctionT7(LuaFile, Reader));
            }
